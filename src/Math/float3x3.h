...
//	static float3x3 CovarianceMatrix(const float3 *pts, int num);
...
//	float3x3 Adjugate() const;
	...
	void BatchTransform(float3 *pts, int num) const;

	/// Performs a batch transform of the given array.
	void BatchTransform(float3 *pts, int num, int stride) const;
