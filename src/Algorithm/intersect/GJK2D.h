...
inline bool GJKIntersect2D(const vec2d *a, int na, const vec2d *b, int nb)
{
...
inline bool GJKContainsPt2D(const vec2d *a, int na, const vec2d &b)
{
    Polygon2DRef p1 = {a, na};
    GJKVec2DProxy p2 = b;
    return GJKIntersect2D(p1, p2);
...
inline bool GJKIntersectOBB2D(const vec2d *a, int na, const vec2d &center,
